...
from app.services.scenario_service import END_SESSION_BUTTON, MAIN_MENU, action_for_label
...
TELEGRAM_BUTTON_LABEL_ALIASES = {
    ...
    "Приёмная кампания 2026/27": "Поступление в колледж",
    "Поступление в колледж": "Поступление в колледж",
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    reply_markup, callback_labels = scenario_keyboard(MAIN_MENU, include_end=False)
