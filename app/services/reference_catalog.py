...
INDUSTRY_ALIASES: dict[str, tuple[str, ...]] = {
    "it": ("it", "айти", "программирование", "разработка", "цифровые технологии", "информационные технологии"),
    "design": ("дизайн", "дизайнер", "креатив", "рисование", "арт", "фотография"),
    "music": ("музыка", "музык", "джаз", "вокал", "сцена"),
    "law": ("право", "юрист", "юриспруденция", "полиция", "безопасность"),
    ...
    "medicine": ("медицина", "медицин", "здоровье", "медик", "сестринское"),
    "construction": ("строительство", "архитектура", "инженерия", "инженер", "сварщик"),
